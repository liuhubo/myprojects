...
//come from>>http://blog.csdn.net/baolong47/article/details/6735853
public class Server {
	...
	public Server() {
		...
		frame.setIconImage(Toolkit.getDefaultToolkit().createImage(Server.class.getResource("06.jpg")));
